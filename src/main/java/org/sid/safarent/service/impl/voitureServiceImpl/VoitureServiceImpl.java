...
import org.sid.safarent.dao.voitureDao.VoitureDao;
import org.sid.safarent.service.facade.communService.ReservationService;
...
import org.sid.safarent.service.facade.voitureService.VoitureService;
...
public class VoitureServiceImpl implements VoitureService {
    ...
    public int save(Voiture voiture) {
        try {
            if(voiture.getMatricule()==null){return -1;}
            if(voitureDao.findByMatricule(voiture.getMatricule())!=null){return -6;}

            if (voiture.getCategorieVoiture()==null ) {
                return -2;
            }
            if (voiture.getAgenceLocation()==null){return -3;}

            else if(voiture.getCategorieVoiture().getLibelle()==null && voiture.getAgenceLocation().getIceAgLoc()==null) {return -4;}
            else {
