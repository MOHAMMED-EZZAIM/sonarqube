package org.sid.safarent.bean.appartementBean;
...
public class Appartement {
    ...
    public <E> Appartement(String apt00124, int i, String s, String asafai, String oui, int i1, String oui1, double v, ArrayList<E> es, CategoriesAppartement categoriesAppartement4, AgenceAppartement agenceAppartement4, HashSet<E> es1) {
    }

    public <E> Appartement(long l, String app0042, int i, String s, String cityD, String yes, int i1, String yes1, double v, ArrayList<E> es, CategoriesAppartement categoriesAppartement4, AgenceAppartement agenceAppartement4, HashSet<E> es1) {
    }
    ...
    public Appartement(String code, int superficie, String adresse, String ville, String wifi, int nmbrPersont, String climatiseur, double loyerMensuel, List<Reservation> reservation, CategoriesAppartement categoriesAppartement, AgenceAppartement agenceAppartement) {
        this.code = code;
