...
public class AgenceAppartement extends AppUser {
    ...
    public AgenceAppartement(String username, String password, Long iceAgApp, String raisonSocialAg, String numTele, String email, String adresse, int numCompteBkAgApp, Long ribAgenceApp, Long RCAgApp) {
